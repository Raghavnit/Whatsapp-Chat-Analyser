...
This repository contains the **WhatsApp Chat Analyzer** project, a tool that allows you to analyze and extract insights from WhatsApp chat exports. The project is developed by Raghav Kanodia and is written in Python.
...
The project utilizes various open-source libraries and tools. See the [`requirements.txt`]
